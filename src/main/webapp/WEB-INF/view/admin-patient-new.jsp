<form:form action="/admin/patient/new" modelAttribute="patient" cssClass="form-vertical">
    <div class="row">
        <div class="col-md-2">
        ...
        <div class="col-md-8">
            <h3 class="form-title text-center"><fmt:message key="form.patient.registration"/></h3>
        </div>
        <div class="col-md-2">
