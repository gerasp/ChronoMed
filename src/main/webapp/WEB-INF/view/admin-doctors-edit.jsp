asdfasdfasdasdadsasdsafasdfadsfadfadsf
                ...
                <%--<div class="row">--%>
                    <%--<div class="col-md-6">--%>
                        ...
                        <%--<div class="form-group">--%>
                            ...
                            <%--<input type="text" required name="idCard" class="form-control" id="inputIdCard"--%>
                                   <%--value="<%= doctor.getIdCard()%>">--%>
                        <%--</div>--%>
                        <%--<div class="form-group">--%>
                    ...
                    <%--<div class="col-md-12">--%>
                        <%--<div class="form-group">--%>
                            ...
                            <%--<input type="email" required name="email" class="form-control"--%>
                                   <%--id="inputEmail" value="<%= doctor.getUserByUserAccountId().getEmail()%>">--%>
                        <%--</div>--%>
                        <%--<div class="form-group">--%>
                            <%--<label for="inputActivation" class="control-label"><fmt:message key="form.active"/></label>--%>
                            <%--<br>--%>
                            <%--<input type="checkbox" value="<% if (doctor.getUserByUserAccountId().getActive()) {--%>
                                                            <%--out.print("on");--%>
                                                        <%--} %> " name="isActivated"--%>
                                <%--<% if (doctor.getUserByUserAccountId().getActive()) {--%>
                                                                   <%--out.print("checked");--%>
                                                               <%--}%>--%>
