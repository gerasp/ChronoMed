            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" disabled id="inputSurname" name="surname"
                               value="<%= patient.getSurname()%>" required>
                    </div>
                    <div class="form-group">
                        <label for="inputIdcard" class="control-label"><fmt:message key="form.idcard"/></label>
                        <input type="text" class="form-control" disabled id="inputIdcard" name="idCard"
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" disabled id="inputNationality" name="nationality"
                               value="<%= patient.getNationality()%>" required>
                    </div>
                </div>
            </div>
        </div>
...
<div class="panel panel-primary">
    <div class="panel-heading">
        <h4 class="panel-title">
            <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion"
               href="#collapse2"><fmt:message key="form.healthcards"/></a>
        </h4>
    </div>
...
<div class="panel panel-primary">
    <div class="panel-heading">
        <h4 class="panel-title">
            <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion"
               href="#collapse3"><fmt:message key="form.data.contact"/></a>
        </h4>
    </div>
        ...
        <form class="form-vertical" method="POST" role="form" action="/FrontController">
            ...
            <div class="panel-body">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="inputCountry" class="control-label" contenteditable="true"><fmt:message
                        ...
                        <div class="form-group">
                            ...
                            <input type="tel" class="form-control" id="inputPhoneNumber" name="phoneNumber"
                                   value="<%= patient.getPhoneNumber()%>" required>
                        </div>
                        <div class="form-group">
                            ...
                            <input type="tel" class="form-control" id="inputAlternativePhoneNumber"
                                   name="alternativePhoneNumber" value="<%= patient.getAlternativePhoneNumber()%>">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" id="inputEmail" name="email"
                                   value="<%= patient.getUserAccountID().getEmail()%>">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
