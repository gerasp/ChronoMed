            ...
            <div class="white-container">
                <c:choose>
                    <c:when test="${doctor==null}">
                        <div class="row">
                            <div class="col-md-7">
                                <a class="btn btn-primary btn-lg register-button" href="<c:url value="/admin/doctor/registration"/>">
                                    <i class="fa  fa-plus-circle"></i>&nbsp;
                                    <fmt:message key="navigation.doctor.registration"/>
                                </a>
                            </div>
                            <div class="col-md-5">
                                <form:form action="/admin/doctor/search" modelAttribute="searchByBoardNumber" cssClass="form-horizontal">
