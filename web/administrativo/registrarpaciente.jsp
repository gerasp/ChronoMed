            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="signin-form-container">
                        <form class="form-vertical" role="form" action="/ChronoMed/FrontController" method="POST" >
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <button class="btn btn-block btn-lg btn-link pull-right">Registrar<i class="fa  -circle fa-check-circle"></i></button>
                                </div>
                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="name" id="inputName" placeholder="Fulano" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="inputSurname" class="control-label">Apellidos</label>
                                                <input type="text" class="form-control" name="surname" id="inputSurname" required placeholder="De Tal De Cual">
                                            </div>
                                            <div class="form-group">
                                                <label for="inputDNI" class="control-label">DNI</label>
                                                <input type="text" class="form-control" name="nif" id="inputDNI" required placeholder="65764330F">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="inputBirthDate" class="control-label">Fecha de nacimiento</label>
                                                <input type="date" class="form-control" name="birthdate" required id="inputBirthDate" placeholder="1 de enero de 1970">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="nationality" required id="inputNationality" placeholder="España">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="panel panel-primary">
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-3">
                                                <button type="button" onclick="addHealthCard()" class="btn btn-primary btn-block"><i class="-circle fa  fa-plus-circle"></i>Añadir tarjeta sanitaria&nbsp;</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="inputAddress" required name="address" placeholder="Calle de la Salud 55">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="inputLocality" class="control-label">Localidad*</label>
                                                <input type="" class="form-control" id="inputLocality" required name="locality" placeholder="Gáldar">
                                            </div>
                                            <div class="form-group">
                                                <label for="inputZipcode" class="control-label">Código postal*</label>
                                                <input type="text" class="form-control" id="inputZipcode" required name="zipCode" placeholder="12345">
                                            </div>
                                            <div class="form-group">
                                                <label for="inputProvince" class="control-label">Provincia*</label>
                                                <input type="text" class="form-control" id="inputProvince" required name="province" placeholder="Las Palmas">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="inputCountry" class="control-label" >País*</label>
                                                <input type="" class="form-control" id="inputCountry" required name="country" placeholder="España">
                                            </div>
                                            <div class="form-group">
                                                <label for="inputPhoneNumber" class="control-label">Teléfono principal*</label>
                                                <input type="tel" class="form-control" id="inputPhoneNumber" required name="phoneNumber" placeholder="928555666">
                                            </div>
                                            <div class="form-group">
                                                <label for="inputAlternativePhoneNumber" class="control-label">Teléfono alternativo</label>
                                                <input type="tel" class="form-control" id="inputAlternativePhoneNumber"  name="alternativePhoneNumber" placeholder="666777888">
                                            </div>
                                        </div>
                                    </div>
                                </div>
