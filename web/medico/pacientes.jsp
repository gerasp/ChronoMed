                ...
                <div class="col-md-9">
                    <div class="signin-form-container">
                        ...
                        <div class="list-group">
                            ...
                            <h2 style="text-align: center;"><span class="label label-default"><i class="fa fa-info-circle"></i> Introduzca su DNI o tarjeta sanitaria</span></h2>
                            <%
                            } else if (nifPatientList != null && !nifPatientList.isEmpty()) {
                                for (Patient patient : nifPatientList) {
                            %>
                            <a href="/ChronoMed/medico/vistapacienteshistorial.jsp?id=<%= patient.getId()%>" class="list-group-item">
