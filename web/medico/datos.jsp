                ...
                <div class="col-md-9">
                    ...
                    <div class="signin-form-container">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" disabled id="inputName" name="name" value="<%= doctor.getName()%>" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="inputSurname" class="control-label">Apellidos</label>
                                                <input type="text" class="form-control" disabled id="inputSurname" name="surname" value="<%= doctor.getSurname()%>" required>
                                            </div>
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-6" >
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="inputSpeciality" value="<%= doctor.getSpeciality()%>" disabled="disabled">
                                            </div>
                                            <div class="form-group">
                                                <label for="inputBoardNumber" class="control-label">Nº de colegiado</label>
                                                <input type="text" class="form-control" id="inputBoardNumber" value="<%= doctor.getBoardNumber()%>" disabled="disabled">
                                            </div>
                                            <div class="form-group">
                                                <label for="inputDNI" class="control-label">DNI</label>
                                                <input type="text" class="form-control" disabled id="inputDNI" name="nif" value="<%= doctor.getNif()%>" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapse5">Datos de contacto</a>
                                </h4>
                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="tel" class="form-control" id="inputAlternativePhoneNumber" name="alternativePhoneNumber" value="<%= doctor.getAlternativePhoneNumber()%>">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="inputPhoneNumber" class="control-label">Teléfono de consulta</label>
                                                    <input type="tel" class="form-control" id="inputPhoneNumber" name="phoneNumber" value="<%= doctor.getPhoneNumber()%>">
                                                </div>
